...
if ($argc) {
    ...
    if (0 < $F30ccc8fd3427f97ca35bc6ba6610d01->d4A34259FC10b35fEdbcCda0a23D69aE()) {
        ...
        foreach ($Ecab3ed662352e7c91c6e045c57fac60 as $efa7cefd12388102b27fdeb2f9f68219) {
            ...
            if (f1ca094152763c79018e9f1893eF1E48::D835C2A9787BA794e7590e06621cfa6B($efa7cefd12388102b27fdeb2f9f68219["monitor_pid"], $efa7cefd12388102b27fdeb2f9f68219["stream_id"])) {
                if (!($efa7cefd12388102b27fdeb2f9f68219["on_demand"] == 1 && $efa7cefd12388102b27fdeb2f9f68219["online_clients"] == 0)) {
                    ...
                    if (!(f1cA094152763c79018e9f1893EF1E48::A1ECF5D2A93474B12E622361c656B958($efa7cefd12388102b27fdeb2f9f68219["pid"], $efa7cefd12388102b27fdeb2f9f68219["stream_id"]) && file_exists($f0d5508533eaf6452b2b014beae1cc7c))) {
                    } else {
                        $E3e8a009e88a10ef5bdfcd4630af0f9f = f1cA094152763c79018E9f1893EF1E48::db998aCd76Fcd118b6cDB4E9eDA68580("live", STREAMS_PATH . $efa7cefd12388102b27fdeb2f9f68219["stream_id"] . "_.m3u8");
                        ...
                        if ($efa7cefd12388102b27fdeb2f9f68219["pid"] != $ef4f0599712515333103265dafb029f7) {
                            $F30ccc8fd3427f97ca35bc6ba6610d01->query("UPDATE `streams_sys` SET `pid` = '%d',`progress_info` = '%s',`bitrate` = '%d' WHERE `server_stream_id` = '%d'", $ef4f0599712515333103265dafb029f7, json_encode($Cf06357624313b73c0a6453ccb618bef), $E3e8a009e88a10ef5bdfcd4630af0f9f, $efa7cefd12388102b27fdeb2f9f68219["server_stream_id"]);
                        } else {
                            $F30ccc8fd3427f97ca35bc6ba6610d01->query("UPDATE `streams_sys` SET `progress_info` = '%s',`bitrate` = '%d' WHERE `server_stream_id` = '%d'", json_encode($Cf06357624313b73c0a6453ccb618bef), $E3e8a009e88a10ef5bdfcd4630af0f9f, $efa7cefd12388102b27fdeb2f9f68219["server_stream_id"]);
                        }
                    }
                } else {
                    c872BCFa04b3eAeE1b4A93a0D775B9D7::C6AF00e22ded8567809f9a063Dc97624($efa7cefd12388102b27fdeb2f9f68219["stream_id"], true);
                }
            } else {
                C872BCFA04b3eAEE1b4a93A0D775b9D7::cCE5281ddFb1f4C0D820841761F78170($efa7cefd12388102b27fdeb2f9f68219["stream_id"]);
                usleep(50000);
            }
        }
    }
