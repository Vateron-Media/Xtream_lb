...
kill $(ps aux | grep 'xtreamcodes' | grep -v grep | grep -v 'start_services.sh' | awk '{print $2}') 2>/dev/null
sleep 4
rm /home/xtreamcodes/php/*.pid
sudo -u xtreamcodes /home/xtreamcodes/php/bin/php /home/xtreamcodes/crons/setup_cache.php
sudo -u xtreamcodes /home/xtreamcodes/php/bin/php /home/xtreamcodes/tools/signal_receiver.php >/dev/null 2>/dev/null &
chown -R xtreamcodes:xtreamcodes /sys/class/net
chown -R xtreamcodes:xtreamcodes /home/xtreamcodes
sleep 4
/home/xtreamcodes/nginx_rtmp/sbin/nginx_rtmp
/home/xtreamcodes/nginx/sbin/nginx
