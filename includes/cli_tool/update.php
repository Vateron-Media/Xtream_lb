...
function loadcli() {
    ...
    switch ($rCommand) {
        case 'update':
            ...
            $URL = "https://github.com/Vateron-Media/Xtream_lb/releases/download/{$nextVersion}/update.tar.gz";
...
function getNextVersionUpdate($curentVersion, $updateVersion) {
    ...
    $URLTagsRelease = "https://api.github.com/repos/Vateron-Media/Xtream_lb/git/refs/tags";
